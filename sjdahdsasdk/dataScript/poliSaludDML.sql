...
INSERT INTO Cita (idPersonaPaciente, idPersonaDoctor, fechaCita, idHoraCita, observacion, idEstadoCita, fechaModificacion) 
    VALUES   (4, 1,  '2023-01-01', 1,  NULL, 2, DATETIME('now', 'localtime'))
            ...
            ,(49, 29,  '2023-02-18', 13, NULL, 3, DATETIME('now', 'localtime'))
            ,(50, 31, '2023-02-19', 14, NULL, 1, DATETIME('now', 'localtime'));
...
SELECT   c.idCita as Cita, idD.nombre as Doctor, idP.nombre as Paciente, c.fechaCreacion as Cita, h.horaCita as HoraCita, c.observacion as observacion, ec.nombre as EstadoCita
FROM cita c
JOIN horaCita h
JOIN estadoCita ec 
JOIN doctor idD 
